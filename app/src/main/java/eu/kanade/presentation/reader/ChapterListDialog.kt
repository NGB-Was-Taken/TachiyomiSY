...
fun ChapterListDialog(
    ...
    val progressFlow by downloadManager.progressFlow().collectAsState(emptyList<Download>())
    ...
    AdaptiveSheet(
        ...
        LazyColumn(
            ...
            items(
                ...
                val activeDownload = progressFlow.find { it.chapter.id == chapterItem.chapter.id }
